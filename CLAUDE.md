...
`ModuleNotFoundError: fastapi`, с ними даёт 24 проверки из 72 — нет текущего
...
```bash
.venv/bin/python checks/run_checks.py     # 72 проверки, включая три ниже и клиентскую
...
на стенде `checks/dom.js` — минимальный DOM и сервер.
