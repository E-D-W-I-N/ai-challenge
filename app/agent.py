...
class Agent:
    ...
    def turn_tools(self, spec: AgentSpec, turn: int) -> list[dict] | None:
        """Что объявить модели на этом обороте: инструменты чата — или
        ничего на последнем разрешённом (`MAX_TURNS`).
        ...
        * ответ частичный (обрыв, отмена) → пишутся обе реплики, у ответа
        ...
        async with self._lock:
            ...
            while True:
                ...
                # стоит ниже и считает сами обороты.
                tools = self.turn_tools(spec, turn)
                turn_text = ""
                turn_reasoning = ""
