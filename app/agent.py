...
class Agent:
    ...
    def exchanges(self) -> int:
        ...
        Считаются **все** ответы, а не только принёсшие числа: плитка
        «Сообщений» отвечает на вопрос «сколько раз поговорили», и карточек
        в ленте ровно столько же. Слагаемых в суммах может быть меньше —
        провайдер вправе смолчать о usage, — но это видно по самим суммам,
        а не по счётчику.
        """
