...
(что важного сказано в разговоре, парами «ключ — значение»), `branches`
...
-- и рабочая (`summaries`, `facts`) привязаны к чату и умирают вместе с ним,
...
class Store:
    ...
    def clear(self) -> None:
        """Стирает базу целиком, включая `meta`, сводки, факты, родство
