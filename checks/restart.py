...
питона, один за другим, и даёт им один файл базы. Заглушка печатает то, что
агент собрался отправить, — по промпту и видно, что память вернулась из базы:
сам вопрос второго процесса ни имени, ни города не содержит.
"""
