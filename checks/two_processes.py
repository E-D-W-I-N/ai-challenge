...
Стенд и консоль работают с одним файлом `data/agents.db`, значит
одновременные писатели — штатный режим, и проверять его надо процессами,
которые **живут одновременно**, а не по очереди.
