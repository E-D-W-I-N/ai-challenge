...
function buildServer(options) {
  ...
  const TASK_PLAN = {
    ...
    execution: {
      ...
      guide: "работай, а не обещай работать: выдавай результат сразу "
        + "и разрешения на каждый шаг не спрашивай; держись "
    ...
    validation: {
      ...
      expecting: "вердикт",
      guide: "проверь сделанное сразу, а не обещай проверить, "
