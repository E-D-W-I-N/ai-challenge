...
# правило, ждущее, когда слово вернётся, и проверка это скажет. Оба слова
# здесь — обычные слова языка: «children» вне реестра это свойство DOM-узла,
# «карандаш» вне разметки — то, чем README и проверки называют кнопку
# переименования. Поле реестра стережётся ещё и поведением
